...
impl_integer_for_isize!(u8);
impl_integer_for_isize!(u16);
impl_integer_for_isize!(u32);
impl_integer_for_isize!(u64);
impl_integer_for_isize!(u128);
impl_integer_for_isize!(usize);
